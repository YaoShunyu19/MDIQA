...
from local_training_20240727.utils.registry import DATASET_REGISTRY
...
_dataset_modules = [importlib.import_module(f'local_training_20240727.data.{file_name}') for file_name in dataset_filenames]
